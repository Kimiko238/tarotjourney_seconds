...
export function CelticCrossLayout({ cards }: SpreadLayoutProps) {
  ...
  const positions = [
    ...
    { x: "82%", y: "63%", rotation: 0 },
    { x: "82%", y: "38%", rotation: 0 },
    { x: "82%", y: "13%", rotation: 0 },
  ];

  return (
    <div className="relative h-[900px] w-full overflow-hidden rounded-2xl border border-slate-200 bg-slate-50">
